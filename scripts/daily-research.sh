#!/bin/bash
# =============================================================================
# PE Daily Research - launchd entry point
# =============================================================================
# launchd가 매일 호출. Claude Code를 headless mode로 실행하여
# 리서치 리포트 생성 후 Notion에 저장.
#
# 실행 시각: 08:45 KST (9시 업무 시작 전 완료 목표)
# 견고성: 네트워크 대기 + 인증 사전체크 + 재시도
# =============================================================================
